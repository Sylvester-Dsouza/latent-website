...
import { Shield, Lock, Eye, Users, FileText, Database, Settings, AlertTriangle } from "lucide-react";
    ...
    <>
      <div className="min-h-screen bg-background">
        ...
        <section className="relative py-20 pt-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          {/* Light background image - with unique positioning for privacy policy */}
          <div 
            className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-10 transform -rotate-3 scale-105"
